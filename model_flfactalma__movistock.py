...
# @class_declaration sanhigia_informes_movistock #
class sanhigia_informes_movistock(interna_movistock, helpers.MixinConAcciones):
    pass
...
class movistock(sanhigia_informes_movistock, helpers.MixinConAcciones):
    pass
