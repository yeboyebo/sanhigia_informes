...
# @class_declaration sanhigia_informes_ejercicios #
class sanhigia_informes_ejercicios(interna_ejercicios, helpers.MixinConAcciones):
    pass
...
class ejercicios(sanhigia_informes_ejercicios, helpers.MixinConAcciones):
    pass
