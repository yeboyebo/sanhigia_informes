...
# @class_declaration sanhigia_informes_impuestos #
class sanhigia_informes_impuestos(interna_impuestos, helpers.MixinConAcciones):
    pass
...
class impuestos(sanhigia_informes_impuestos, helpers.MixinConAcciones):
    pass
