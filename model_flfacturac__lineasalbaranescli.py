...
# @class_declaration sanhigia_informes_lineasalbaranescli #
class sanhigia_informes_lineasalbaranescli(interna_lineasalbaranescli, helpers.MixinConAcciones):
    pass
...
class lineasalbaranescli(sanhigia_informes_lineasalbaranescli, helpers.MixinConAcciones):
    pass
