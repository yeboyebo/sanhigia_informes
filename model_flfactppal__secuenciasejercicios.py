...
# @class_declaration sanhigia_informes_secuenciasejercicios #
class sanhigia_informes_secuenciasejercicios(interna_secuenciasejercicios, helpers.MixinConAcciones):
    pass
...
class secuenciasejercicios(sanhigia_informes_secuenciasejercicios, helpers.MixinConAcciones):
    pass
