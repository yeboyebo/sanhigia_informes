...
# @class_declaration sanhigia_informes_usuarios #
class sanhigia_informes_usuarios(interna_usuarios, helpers.MixinConAcciones):
    pass
...
class usuarios(sanhigia_informes_usuarios, helpers.MixinConAcciones):
    pass
